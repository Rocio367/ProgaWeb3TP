...
namespace GestorDePedidos.Controllers
{
    public class PedidoController : BaseController
    {
        ...
        public ActionResult Lista()
        {
            ...
            model.solo_ultimos_dos_meses = true;
        ...
        public ActionResult Filtrar(int id_estado, int id_cliente, Boolean eliminados, Boolean solo_ultimos_dos_meses, int? page = 1)
        {
            ListaPedidoVM model = new ListaPedidoVM();
            ...
            if (id_cliente == 0 && id_estado == 1 && eliminados && solo_ultimos_dos_meses)
            {
                model.pedidos = this._servicioPedido.ObtenerPedidosSinFiltro().ToPagedList(page.Value, 10);

            }
            else
            {
                model.pedidos = this._servicioPedido.ObtenerPedidosConFiltro(model.id_cliente, model.id_estado, eliminados, solo_ultimos_dos_meses).ToPagedList(page.Value, 10);
